...
Phase 1 guarantees two pinned memories exist:
- `robot_identity.md` (type `robot_fact`) — deterministic, always refreshed.
- `safety_gotcha.md` (type `safety_gotcha`) — bootstrapped once, then **human-maintained**, always recalled.

Docs:
- `docs/memory-system-design.md`
- `docs/memory-write-protocol.md` (Phase 2 design checkpoint: schema/approvals/conflicts/retention/fleet)
- `docs/ROADMAP.md` + `docs/TODO.md` (living roadmap + actionable checklist)
